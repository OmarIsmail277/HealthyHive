...
function AccordionItem({ question, answer, isOpen, onToggle, searchQuery }) {
  return (
    <div className="border border-green-200 rounded-lg shadow-sm overflow-hidden bg-white">
      <button
        onClick={onToggle}
        className="flex justify-between items-center w-full px-5 py-4 bg-green-50 hover:bg-green-100 transition text-left focus:outline-green-600 focus:ring-2 focus:ring-green-400 text-lg font-semibold text-green-700"
...
export default function FAQPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-16 px-6 md:px-12 lg:px-24 select-none">
      <h1 className="max-w-4xl mx-auto text-5xl font-extrabold text-green-700 mb-10 text-center">
        FAQs
      </h1>
      ...
      >
        ...
        <div className="flex gap-3 flex-shrink-0">
          <button
            onClick={expandAll}
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-lg shadow transition focus:outline-none focus:ring-2 focus:ring-green-500"
          ...
          <button
            onClick={collapseAll}
            className="flex items-center gap-2 bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-3 rounded-lg shadow transition focus:outline-none focus:ring-2 focus:ring-gray-400"
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-stretch gap-16">
        ...
        <section
          ...
          style={{
            ...
            backgroundImage:
              "radial-gradient(circle at top left, #d1fae5 1px, transparent 1px)",
