...
function CartCheckout() {
    ...
    const handleShippingChange = (value) => {
        ...
        setDelivery(value === "delivery" ? 20 : 0);
    };
            ...
            <div className="2xl:w-1/4 border border-gray-300 bg-white rounded-xl shadow-md p-4">
                ...
                <div className="border-b border-gray-300 pb-4 mb-4">
                    ...
                    <div className="space-y-3">
                        ...
                        {/* Store Pickup */}
                        <label
                            className={`flex items-center gap-4 p-4 border rounded-xl cursor-pointer transition ${shippingMethod === "pickup"
                        ...
                        {/* Home Delivery */}
                        <label
                            className={`flex items-center gap-4 p-4 border rounded-xl cursor-pointer transition ${shippingMethod === "delivery"
                                ? "border-primary bg-blue-50 shadow-sm"
                                : "border-gray-200 hover:border-[#16a34a58]"
                                }`}
                        >
                ...
                <div className="flex justify-between">
                    ...
                    <p className="font-semibold">{subTotal + delivery} LE</p>
                </div>
